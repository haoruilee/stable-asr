...
DEFAULT_FINAL_EXPERIMENTS: dict[str, Any] = {
    ...
    "experiments": [
        ...
        },
        {
            ...
            "commands": [
                "stable-asr reproduce-paper --config configs/final/paper_final.json",
            ...
            "expected_artifacts": ["ARTIFACT_INDEX.md", "artifact_manifest.json", "PAPER_PARITY.md", "CLAIMS.md", "paper.tex"],
            "success_criteria": [
