...
DEFAULT_BENCHMARK_SUITE: dict[str, Any] = {
    ...
    "required_artifacts": [
        ...
        "BENCHMARK_SUITE.md",
        "starter_packs/benchmark_pack/manifest.json",
        "starter_packs/benchmark_pack/README.md",
        "starter_packs/adapter_pack/manifest.json",
        "starter_packs/adapter_pack/README.md",
        "model_registry.json",
        "MODELS.md",
        "model_card.json",
        "MODEL_CARD.md",
