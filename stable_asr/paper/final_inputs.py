...
DEFAULT_FINAL_INPUT_COLLECTIONS: dict[str, Any] = {
    ...
    "collections": [
        ...
        },
        {
            ...
            "license": "project_license",
            "source_urls": [],
            "required_paths": ["runs/final/paper_results.json", "runs/final/artifacts"],
            "generated_paths": ["runs/final/artifacts.tar.gz", "runs/final/artifacts.tar.gz.sha256"],
            "commands": [
            ...
            "verification": [
                ...
                "stable-asr paper-release-audit --repo-root . --results runs/final/paper_results.json --artifacts-dir runs/final/artifacts --model-card runs/final/MODEL_CARD.md",
            ],
