...
def paper_artifact_bundle(results_path: str | Path, output_dir: str | Path) -> PaperArtifactBundle:
    ...
    reference_workqueue = {
        ...
        "license_review_templates_markdown": str(output_dir / "REFERENCE_LICENSE_REVIEW_TEMPLATES.md"),
    ...
    Path(reference_workqueue["license_review_templates_markdown"]).write_text(
        reference_workqueue_license_review_markdown(reference_workqueue_report),
        encoding="utf-8",
    )
