...
DEFAULT_ADAPTER_REGISTRY: dict[str, Any] = {
    ...
    "adapters": [
        ...
        {
            "id": "vap_prediction",
            "title": "VAP Prediction Converter",
            "task": "turn_taking",
            "modality": "external_prediction_jsonl",
            "status": "converter_implemented",
            "interface": "TurnPredictionManifestAdapter",
            "entrypoint": "stable-asr convert-predictions --schema vap",
            "input_schema": "VAP-style future voice activity JSONL",
            "output_schema": "Stable-ASR turn prediction JSONL",
            "license": "see_upstream",
            "related_references": ["vap"],
            "notes": "Maps VAP-style future user/system activity scores to Stable-ASR turn probabilities.",
        },
    ],
}
