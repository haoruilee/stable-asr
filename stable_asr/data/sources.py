...
DEFAULT_DATA_SOURCES: dict[str, Any] = {
    ...
    "sources": [
        ...
        },
        {
            ...
            "status": "recipe_implemented",
            "stable_asr_entrypoint": (
                "stable-asr prepare-public-asr --corpus wenetspeech "
                "--input-dir <WenetSpeech> --split <train|dev|test_net|test_meeting> "
                "--output <manifest.jsonl>"
            ),
            "license": "see_upstream",
            "notes": "Large Mandarin ASR source; v0 parses WenetSpeech.json audios/segments or flattened JSONL exports into segment-level ASR manifests.",
        },
        {
            "id": "common_voice",
            "title": "Common Voice",
