...
`final-handoff-checksums` and verified by `final-handoff-audit --require-checksums`.
...
- `final-handoff-template`, `final-handoff-checksums`, and `final-handoff-audit` for structured owner/license/path/checksum verification before accepting final inputs
...
- `final-assignment-audit`, `final-handoff-template`, `final-handoff-checksums`, and `final-handoff-audit` for turning real final-scale staged inputs into auditable owner, due-date, release-blocker, license/consent, verification, path, and checksum evidence
