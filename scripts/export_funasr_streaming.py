"""Normalize a precomputed FunASR JSONL export for Stable-ASR final runs.

This bridge does not run FunASR inference. It validates a shared ASR manifest,
converts a checked FunASR-style raw export to Stable-ASR StreamingASRRecord
