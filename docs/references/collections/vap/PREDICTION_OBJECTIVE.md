# Voice Activity Projection Stable-ASR Reference Evidence

## Upstream version and source

- reference_id: `vap`
- source_url: https://github.com/ErikEkstedt/VoiceActivityProjection
- docs_url: https://arxiv.org/abs/2205.09812
- acquisition_track: `turn prediction objective bridge`
- priority: `p0`
...
- map_future_activity_to_turn_probs
- compare_stereo_dialogue_objectives
...
- evidence_target: `docs/references/collections/vap/PREDICTION_OBJECTIVE.md`
- license_review_target: `docs/references/collections/vap/LICENSE_REVIEW.md`
...
Reference use: Use as a continuous turn-prediction objective and external prediction-converter target.
