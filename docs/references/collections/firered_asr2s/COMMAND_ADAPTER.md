# FireRedASR2S Stable-ASR Reference Evidence

## Upstream version and source

- reference_id: `firered_asr2s`
- source_url: https://github.com/FireRedTeam/FireRedASR2S
- docs_url: https://github.com/FireRedTeam/FireRedASR2S
...
- benchmark_chinese_code_switching
- compare_word_timestamp_outputs
...
- evidence_target: `docs/references/collections/firered_asr2s/COMMAND_ADAPTER.md`
- license_review_target: `docs/references/collections/firered_asr2s/LICENSE_REVIEW.md`
...
Reference use: Study Chinese-first system outputs, word timestamps, VAD segments, language labels, and JSONL export shape for interaction-level evaluation.
