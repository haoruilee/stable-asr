# Hugging Face Transformers ASR Stable-ASR Reference Evidence

## Upstream version and source

- reference_id: `huggingface_transformers_asr`
- source_url: https://github.com/huggingface/transformers
- docs_url: https://huggingface.co/docs/transformers/tasks/asr
...
- plan_hf_adapter
- compare_model_card_fields
- track_finetuning_recipe_inputs
...
- evidence_target: `docs/references/collections/huggingface_transformers_asr/COMMAND_ADAPTER.md`
- license_review_target: `docs/references/collections/huggingface_transformers_asr/LICENSE_REVIEW.md`
...
Reference use: Study adapter conventions for hub models, training/evaluation examples, and model-card workflows.
