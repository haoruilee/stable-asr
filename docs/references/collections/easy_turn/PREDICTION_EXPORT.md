# Easy Turn Stable-ASR Reference Evidence

## Upstream version and source

- reference_id: `easy_turn`
- source_url: https://arxiv.org/abs/2509.23938
- docs_url: https://huggingface.co/ASLP-lab/Easy-Turn
...
- compare_four_state_turn_labels
- track_bimodal_baseline_gap
...
- evidence_target: `docs/references/collections/easy_turn/PREDICTION_EXPORT.md`
- license_review_target: `docs/references/collections/easy_turn/LICENSE_REVIEW.md`
...
Reference use: Use as a multimodal complete, incomplete, backchannel, and wait baseline.
