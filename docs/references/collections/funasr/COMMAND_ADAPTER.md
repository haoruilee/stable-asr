...
- benchmark_chinese_streaming
- compare_auxiliary_outputs
...
- evidence_target: `docs/references/collections/funasr/COMMAND_ADAPTER.md`
- license_review_target: `docs/references/collections/funasr/LICENSE_REVIEW.md`
...
Reference use: Study industrial Chinese ASR ergonomics, streaming service interfaces, and one-call speech understanding APIs.
