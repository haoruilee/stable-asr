# whisper.cpp Stable-ASR Reference Evidence

## Upstream version and source

- reference_id: `whisper_cpp`
...
- evidence_target: `docs/references/collections/whisper_cpp/COMMAND_ADAPTER.md`
- license_review_target: `docs/references/collections/whisper_cpp/LICENSE_REVIEW.md`
...
Reference use: Study portable runtime packaging, quantization-facing reports, command-line transcript export, and edge latency measurement.
