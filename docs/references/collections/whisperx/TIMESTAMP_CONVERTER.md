...
- plan_transcript_converter
- benchmark_timestamp_stability
- compare_diarization_metadata
...
- evidence_target: `docs/references/collections/whisperx/TIMESTAMP_CONVERTER.md`
- license_review_target: `docs/references/collections/whisperx/LICENSE_REVIEW.md`
...
Reference use: Study word timestamp stability, diarization-aware transcript outputs, and long-form alignment evaluation.
...
- upstream_license_field: `BSD-4-Clause`
