# sherpa-onnx Stable-ASR Reference Evidence

## Upstream version and source

- reference_id: `sherpa_onnx`
...
- plan_onnx_runtime_benchmark
- compare_cpu_latency
- track_websocket_adapter
...
- evidence_target: `docs/references/collections/sherpa_onnx/COMMAND_ADAPTER.md`
- license_review_target: `docs/references/collections/sherpa_onnx/LICENSE_REVIEW.md`
...
Reference use: Study deployable ASR runtime APIs, ONNX packaging, streaming examples, and embedded constraints.
