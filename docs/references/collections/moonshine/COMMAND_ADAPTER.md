# Moonshine Stable-ASR Reference Evidence

## Upstream version and source

- reference_id: `moonshine`
- source_url: https://github.com/moonshine-ai/moonshine
- docs_url: https://github.com/moonshine-ai/moonshine
...
- benchmark_live_latency
- compare_partial_transcript_events
...
- evidence_target: `docs/references/collections/moonshine/COMMAND_ADAPTER.md`
- license_review_target: `docs/references/collections/moonshine/LICENSE_REVIEW.md`
...
Reference use: Study streaming transcript events, bounded-latency ASR design, and edge-device benchmark reporting.
