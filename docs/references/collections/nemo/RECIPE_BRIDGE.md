# NVIDIA NeMo Speech Stable-ASR Reference Evidence

## Upstream version and source

- reference_id: `nemo`
- source_url: https://github.com/NVIDIA-NeMo/NeMo
- docs_url: https://docs.nvidia.com/nemo/speech/
...
- track_model_cards
- compare_latency_quality_tradeoffs
...
- evidence_target: `docs/references/collections/nemo/RECIPE_BRIDGE.md`
- license_review_target: `docs/references/collections/nemo/LICENSE_REVIEW.md`
...
Reference use: Study large-model ASR configuration, pretrained checkpoint handling, and deployment-oriented reporting.
