# Lhotse Stable-ASR Reference Evidence

## Upstream version and source

- reference_id: `lhotse`
- source_url: https://github.com/lhotse-speech/lhotse
- docs_url: https://lhotse-speech.github.io/
- acquisition_track: `data bridge`
- priority: `p0`
...
- align_manifest_concepts
- avoid_duplicate_corpus_recipes
- plan_lhotse_bridge
...
- evidence_target: `docs/references/collections/lhotse/DATA_BRIDGE.md`
- license_review_target: `docs/references/collections/lhotse/LICENSE_REVIEW.md`
...
Reference use: Study robust manifest design, corpus preparation recipes, and data-layer interoperability.
