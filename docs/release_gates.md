...
- `reference-workqueue --audit-evidence` can distinguish reference plans from completed evidence by checking every included evidence target and required license-review file on disk
