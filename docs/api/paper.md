...
- `stable_asr.paper.scenario_pack.build_scenario_pack`
...
report = merge_leaderboard_jsonl(
    [
        "runs/submissions/oracle_fixture/leaderboard.jsonl",
        "runs/submissions/streaming_fixture/leaderboard.jsonl",
    ],
    "runs/submissions/leaderboard.jsonl",
)
print(report.to_text())
```
