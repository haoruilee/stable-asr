...
stable-asr benchmark-train-features --dataset runs/final/voiceworld_real.jsonl --output-dir runs/final/train_feature_bench --formats source_audio source_audio_file_cache parquet lance --sample-count 1000
```
